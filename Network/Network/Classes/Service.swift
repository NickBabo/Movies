...
/// Protocol that represents a service (or request) that can be executed by the Network module.
public protocol ServiceProtocol {
    ...
    /// If `true`, an implementation of the `NetworkDelegate`'s method `getToken()` will be called
