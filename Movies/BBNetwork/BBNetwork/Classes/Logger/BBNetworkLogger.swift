...
enum BBNetworkLogger {

    private enum Line {
        static let header = "--- 🌎 BBNetwork 🌏 ---"
    ...
    static func log(request: URLRequest) {
        ...
        let log = BBNetworkLogger.buildLog([Line.header,
                                            Line.request,
                                            url,
                                            method,
                                            requestHeader,
    ...
    static func log(data: Data?, response: HTTPURLResponse) {
        ...
        let log = BBNetworkLogger.buildLog([Line.response,
                                            statusCode,
                                            responseData,
                                            Line.separator])
        debugPrint(log)
    ...
    static func log(error: BBAPIError) {
